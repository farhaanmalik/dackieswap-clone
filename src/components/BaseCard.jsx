            ...
            <div className="py-6 m-auto px-6" style={{ maxWidth: "1200px" }}>
                <div className="md:flex block">
                    ...
                    <div className="md:w-6/12 w-full md:mx-3 mx-0 md:mt-0 mt-6">
                        <div className="bg-white cursor-pointer p-6 mb-6 shadow-[0px_0px_60px_0px_#0000001a] hover:shadow-[0px_0px_15px_0px_#0066ff92] transition-all duration-200" style={{ borderRadius: "16px" }}>
                        ...
                        <div className="bg-white cursor-pointer p-6 mt-6 shadow-[0px_0px_60px_0px_#0000001a] hover:shadow-[0px_0px_15px_0px_#0066ff92] transition-all duration-200" style={{ borderRadius: "16px" }}>
                            <div className='flex items-center text-2xl font-semibold text-[#06f]'>
                                <span>NFT Pools</span>
                                <span className='pl-4 text-base'><i className="fa-solid fa-up-right-from-square"></i></span>
                            </div>
